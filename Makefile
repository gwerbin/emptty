...
install-all: install install-manual install-pam nstall-config install-motd-gen
install-all-debian: install install-manual install-pam-debian install-systemd install-config install-motd-gen
install-all-fedora: install install-manual install-pam-fedora install-systemd install-config install-motd-gen
install-all-suse: install install-manual install-pam-suse install-systemd install-config install-motd-gen
